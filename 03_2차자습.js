...
// 🟦 콜백함수 만들기
    ...
    // 1. 콜백함수를 품고 있는게 일반함수인 경우(콜백함수로 일반함수를 사용) 
    
        // 1.1 고차함수 선언 (콜백을 품고있는 함수선언) 
    ...
    // 2. 객체 활용해서 콜백함수 사용하기 (콜백함수로 객체.메소드() 를 사용하는 경우) 
    ...
    // '일반함수'와 '화살표 함수' 의 차이점 ⭐⭐⭐⭐⭐ 
        ...
        // 2.0 this 란? 
            // this는 '함수가 호출'될 때 '해당 함수가 속한 객체'를 가리키는 예약어
                // 전제 : 모든 함수는 객체 안에 담겨있다. ⭐️⭐️⭐️⭐️⭐️
